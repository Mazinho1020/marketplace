...
Route::group(['prefix' => 'fidelidade', 'as' => 'fidelidade.'], function () {
    ...
    Route::group(['prefix' => 'carteiras', 'as' => 'carteiras.'], function () {
        ...
        Route::post('/{id}/ajustar-saldo', [CarteirasController::class, 'ajustarSaldo'])->name('ajustar-saldo');
        Route::post('/{id}/bloquear', [CarteirasController::class, 'bloquear'])->name('bloquear');
        Route::post('/{id}/desbloquear', [CarteirasController::class, 'desbloquear'])->name('desbloquear');
    ...
    Route::group(['prefix' => 'transacoes', 'as' => 'transacoes.'], function () {
        ...
        Route::get('/{id}', [TransacoesController::class, 'show'])->name('show');
