            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.empresas.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.financeiro.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.pdv.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.delivery.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.relatorios.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.sistema.index')); ?>">
