            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('fidelidade.*') ? 'active' : ''); ?>" href="#fidelidadeSubmenu" data-bs-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('fidelidade.*') ? 'true' : 'false'); ?>">
                                <i class="fas fa-star me-2"></i>
                                Fidelidade
                                <i class="fas fa-chevron-down ms-auto"></i>
                            </a>
                            <div class="collapse <?php echo e(request()->routeIs('fidelidade.*') ? 'show' : ''); ?>" id="fidelidadeSubmenu">
                                <ul class="list-unstyled ps-3">
                                    <li><a href="<?php echo e(route('fidelidade.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.dashboard') ? 'active' : ''); ?>"><i class="fas fa-chart-line me-2"></i>Dashboard</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.carteiras.index')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.carteiras.*') ? 'active' : ''); ?>"><i class="fas fa-wallet me-2"></i>Carteiras</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.transacoes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.transacoes.*') ? 'active' : ''); ?>"><i class="fas fa-exchange-alt me-2"></i>Transações</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.cupons.index')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.cupons.*') ? 'active' : ''); ?>"><i class="fas fa-ticket-alt me-2"></i>Cupons</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.regras.index')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.regras.*') ? 'active' : ''); ?>"><i class="fas fa-rules me-2"></i>Regras</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.relatorios.index')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.relatorios.*') ? 'active' : ''); ?>"><i class="fas fa-chart-bar me-2"></i>Relatórios</a></li>
                                    <li><a href="<?php echo e(route('fidelidade.configuracoes')); ?>" class="nav-link <?php echo e(request()->routeIs('fidelidade.configuracoes') ? 'active' : ''); ?>"><i class="fas fa-cogs me-2"></i>Configurações</a></li>
                                </ul>
                            </div>
                        </li>
