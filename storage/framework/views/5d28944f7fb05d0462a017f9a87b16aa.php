                ...
                <div class="login-container row g-0">
                    ...
                    <div class="col-md-6 login-right">
                        <div>
                            ...
                            <!-- Formulário de Login -->
                            <form method="POST" action="<?php echo e(route('comerciantes.login')); ?>" id="loginForm">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="text-center mt-4 pt-4" style="border-top: 1px solid var(--border);">
                                <small class="text-muted">
                                    © <?php echo e(date('Y')); ?> Marketplace. Todos os direitos reservados.
                                </small>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciantes/auth/login.blade.php ENDPATH**/ ?>