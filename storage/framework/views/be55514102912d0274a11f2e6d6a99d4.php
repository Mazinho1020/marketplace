...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('admin.config.index')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('admin.config.create')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('admin.config.export')); ?>">
                ...
                <div class="card mb-3" style="background: rgba(255,255,255,0.8);">
                    <div class="card-body p-2 text-center">
                        ...
                        <h6 class="mb-0 text-gradient">
                            <?php echo e(isset($configsByGroup) ? array_sum(array_map('count', $configsByGroup)) : (isset($configs) ? $configs->count() : 0)); ?>
                ...
                <ul class="nav flex-column">
                    <?php if(isset($grupos)): ?>
                        <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.config.group', $grupo->codigo ?? $grupo->nome ?? 'sistema')); ?>">
                                    <i class="<?php echo e($grupo->icone ?? 'fas fa-folder'); ?> me-2"></i>
                                    <?php echo e($grupo->nome ?? 'Grupo'); ?>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.config.index', ['group' => 'sistema'])); ?>">
                                <i class="fas fa-cog me-2"></i>Sistema
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.config.index', ['group' => 'email'])); ?>">
                                <i class="fas fa-envelope me-2"></i>Email
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.config.index', ['group' => 'fidelidade'])); ?>">
                                <i class="fas fa-star me-2"></i>Fidelidade
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.config.index', ['group' => 'pagamento'])); ?>">
                ...
                <div class="main-content">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e(route('admin.config.create')); ?>" class="btn btn-success">
                    ...
                    <div class="filter-card">
                        <form method="GET" action="<?php echo e(route('admin.config.index')); ?>" class="row g-3">
                            <div class="col-md-3">
                                ...
                                <select name="group" id="group" class="form-select">
                                    ...
                                    <option value="sistema" <?php echo e(request('group') == 'sistema' ? 'selected' : ''); ?>>Sistema</option>
                                    <option value="email" <?php echo e(request('group') == 'email' ? 'selected' : ''); ?>>Email</option>
                                    <option value="fidelidade" <?php echo e(request('group') == 'fidelidade' ? 'selected' : ''); ?>>Fidelidade</option>
                                    <option value="pagamento" <?php echo e(request('group') == 'pagamento' ? 'selected' : ''); ?>>Pagamento</option>
                                    <option value="seguranca" <?php echo e(request('group') == 'seguranca' ? 'selected' : ''); ?>>Segurança</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="tipo" id="tipo" class="form-select">
                                    ...
                                    <option value="string" <?php echo e(request('tipo') == 'string' ? 'selected' : ''); ?>>Texto</option>
                                    <option value="boolean" <?php echo e(request('tipo') == 'boolean' ? 'selected' : ''); ?>>Booleano</option>
                                    <option value="integer" <?php echo e(request('tipo') == 'integer' ? 'selected' : ''); ?>>Número</option>
                                    <option value="email" <?php echo e(request('tipo') == 'email' ? 'selected' : ''); ?>>Email</option>
                                    <option value="url" <?php echo e(request('tipo') == 'url' ? 'selected' : ''); ?>>URL</option>
                                    <option value="json" <?php echo e(request('tipo') == 'json' ? 'selected' : ''); ?>>JSON</option>
                                </select>
                            </div>
                        ...
                        <?php if(request()->hasAny(['group', 'tipo', 'search'])): ?>
                            <div class="mt-3">
                                <a href="<?php echo e(route('admin.config.index')); ?>" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="col-md-3">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">
                                        <?php echo e(isset($configsByGroup) ? count($configsByGroup) : 0); ?>
                    ...
                    <?php if(isset($configsByGroup) && !empty($configsByGroup)): ?>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">
                                        ...
                                        <?php echo e($groupName ?? 'Sem Grupo'); ?>

                                        <span class="badge bg-secondary ms-2"><?php echo e(count($groupConfigs)); ?></span>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <div class="config-item">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <h6 class="mb-1">
                                                            ...
                                                            <?php echo e($config->chave ?? 'N/A'); ?>

                                                            <?php if($config->obrigatorio ?? false): ?>
                                                                <span class="badge bg-danger ms-1">Obrigatório</span>
                                                            <?php endif; ?>
                                                        </h6>
                                                        <span class="badge bg-secondary"><?php echo e($config->tipo_dado ?? 'string'); ?></span>
                                                    </div>
                                                    
                                                    <?php if($config->descricao ?? false): ?>
                                                        <p class="text-muted small mb-3"><?php echo e($config->descricao); ?></p>
                                                    <?php endif; ?>
                                                    ...
                                                    <form class="config-form" data-config-chave="<?php echo e($config->chave ?? ''); ?>">
                                                        <div class="mb-3">
                                                            ...
                                                            <?php if(($config->tipo_dado ?? 'string') === 'boolean'): ?>
                                                                <select class="form-select form-select-sm" name="valor">
                                                                    <option value="0" <?php echo e($currentValue == '0' ? 'selected' : ''); ?>>
                                                                        <i class="fas fa-times me-1"></i>Não (false)
                                                                    </option>
                                                                    <option value="1" <?php echo e($currentValue == '1' ? 'selected' : ''); ?>>
                                                                        <i class="fas fa-check me-1"></i>Sim (true)
                                                                    </option>
                                                                </select>
                                                            <?php elseif(($config->tipo_dado ?? 'string') === 'integer'): ?>
                                                                <input type="number" class="form-control form-control-sm" 
                                                                       name="valor" value="<?php echo e($currentValue); ?>" placeholder="0">
                                                            <?php elseif(($config->tipo_dado ?? 'string') === 'email'): ?>
                                                                <input type="email" class="form-control form-control-sm" 
                                                                       name="valor" value="<?php echo e($currentValue); ?>" placeholder="exemplo@dominio.com">
                                                            <?php elseif(($config->tipo_dado ?? 'string') === 'url'): ?>
                                                                <input type="url" class="form-control form-control-sm" 
                                                                       name="valor" value="<?php echo e($currentValue); ?>" placeholder="https://exemplo.com">
                                                            <?php elseif(($config->tipo_dado ?? 'string') === 'json'): ?>
                                                                <textarea class="form-control form-control-sm" name="valor" rows="3" 
                                                                          placeholder='{"chave": "valor"}'><?php echo e($currentValue); ?></textarea>
                                                            <?php else: ?>
                                                                <input type="text" class="form-control form-control-sm" 
                                                                       name="valor" value="<?php echo e($currentValue); ?>" placeholder="Digite o valor...">
                                                            <?php endif; ?>
                                                        </div>
                                                    ...
                                                    <div class="d-flex gap-1">
                                                        <button class="btn btn-outline-info btn-sm flex-fill" 
                                                                onclick="showConfigHistory('<?php echo e($config->chave ?? ''); ?>')"
                                                                title="Histórico">
                                                            <i class="fas fa-history"></i>
                                                        </button>
                                                        <button class="btn btn-outline-warning btn-sm flex-fill" 
                                                                onclick="resetToDefault('<?php echo e($config->chave ?? ''); ?>')"
                                                                title="Restaurar Padrão">
                                                            <i class="fas fa-undo"></i>
                                                        </button>
                                                        <button class="btn btn-outline-secondary btn-sm flex-fill" 
                                                                onclick="copyConfigKey('<?php echo e($config->chave ?? ''); ?>')"
                                                                title="Copiar Chave">
                                                            <i class="fas fa-copy"></i>
                                                        </button>
                                                    </div>

                                                    <?php if($config->valor_padrao ?? false): ?>
                                                        <div class="mt-3 p-2 bg-light rounded">
                                                            <small class="text-muted">
                                                                <i class="fas fa-info-circle me-1"></i>
                                                                <strong>Valor Padrão:</strong> 
                                                                <code class="bg-white px-2 py-1 rounded"><?php echo e($config->valor_padrao); ?></code>
                                                            </small>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                        ...
                        <div class="text-center mt-4">
                            <div class="alert alert-info">
                                ...
                                <strong>Resumo:</strong> <?php echo e(array_sum(array_map('count', $configsByGroup))); ?> configurações em <?php echo e(count($configsByGroup)); ?> grupos
                            </div>
                        </div>
                    <?php elseif(isset($configs) && $configs->count() > 0): ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php $__currentLoopData = $configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <div class="config-item">
                                                <h6><i class="fas fa-key me-1 text-muted"></i><?php echo e($config->chave ?? 'N/A'); ?></h6>
                                                <p class="text-muted small"><?php echo e($config->descricao ?? 'Sem descrição'); ?></p>
                                                <form class="config-form" data-config-chave="<?php echo e($config->chave ?? ''); ?>">
                                                    <input type="text" class="form-control form-control-sm" 
                                                           name="valor" value="<?php echo e($config->valor_padrao ?? ''); ?>" placeholder="Digite o valor...">
                            ...
                            <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex justify-content-between align-items-center p-3 border rounded mb-2">
                                    <div>
                                        ...
                                        <small class="text-muted"><?php echo e($grupo->descricao ?? 'Sem descrição'); ?></small>
                                    </div>
                                    <div>
                                        <a href="<?php echo e(route('admin.config.index', ['group' => $grupo->codigo ?? $grupo->nome])); ?>" 
    ...
    <script>
        ...
        function updateFilters() {
            ...
            setTimeout(() => {
                if (group || tipo) {
                    window.location.href = '<?php echo e(route("admin.config.index")); ?>?' + params.toString();
                }
            }, 500);
        }
        ...
        document.getElementById('quickCreateForm')?.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.config.store")); ?>', {
                    method: 'POST',
                    body: formData
                });
        ...
        function performQuickSearch() {
            ...
            if (searchTerm.trim()) {
                window.location.href = '<?php echo e(route("admin.config.index")); ?>?search=' + encodeURIComponent(searchTerm);
            }
        }
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/admin/config/index.blade.php ENDPATH**/ ?>