...
<body>
    ...
    <script>
        ...
        function carregarEstatisticas() {
            document.getElementById('regras-ativas').textContent = '<?php echo e($stats["regras_ativas"]); ?>';
            document.getElementById('cashback-distribuido').textContent = 'R$ <?php echo e(number_format($stats["cashback_distribuido"], 2, ",", ".")); ?>';
            document.getElementById('media-cashback').textContent = '3.5%';
            document.getElementById('cashback-mes').textContent = 'R$ <?php echo e(number_format($stats["cashback_distribuido"] * 0.2, 2, ",", ".")); ?>';
        }

        function carregarRegras() {
            const regras = <?php echo json_encode($regras, 15, 512) ?>;
