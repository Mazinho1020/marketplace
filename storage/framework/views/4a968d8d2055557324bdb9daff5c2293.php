...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.index', $empresa)); ?>">Contas a Pagar</a></li>
        ...
        <div>
            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.index', $empresa)); ?>" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-2"></i>Voltar
            </a>
            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.edit', ['empresa' => $empresa, 'id' => $lancamento->id])); ?>" class="btn btn-outline-primary">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <p><strong>Descrição:</strong><br><?php echo e($lancamento->descricao); ?></p>
                            <p><strong>Número do Documento:</strong><br><?php echo e($lancamento->numero_documento ?? 'N/A'); ?></p>
                            <p><strong>Data de Emissão:</strong><br><?php echo e($lancamento->data_emissao ? $lancamento->data_emissao->format('d/m/Y') : 'N/A'); ?></p>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <?php if($lancamento->observacoes): ?>
                                <p><strong>Observações:</strong><br><?php echo e($lancamento->observacoes); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-4">
                            <div class="border-end">
                                ...
                                <h4 class="mb-0 text-success">R$ <?php echo e(number_format($valorPago, 2, ',', '.')); ?></h4>
                            </div>
                        </div>
                        <div class="col-4">
                            <h6 class="text-muted mb-1">Saldo Devedor</h6>
                            <h4 class="mb-0 <?php echo e($saldoDevedor > 0 ? 'text-danger' : 'text-success'); ?>">
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <small class="text-muted"><?php echo e(number_format($percentualPago, 1)); ?>%</small>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-success" role="progressbar" 
                                 style="width: <?php echo e($percentualPago); ?>%" 
                                 aria-valuenow="<?php echo e($percentualPago); ?>" 
                                 aria-valuemin="0" 
                    ...
                    <div class="text-center mt-4">
                        <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.pagamentos.pagamento', ['empresa' => $empresa->id, 'id' => $lancamento->id])); ?>" 
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-primary"><?php echo e($lancamento->pagamentos()->count()); ?> pagamento(s)</span>
        </div>
        <div class="card-body">
            <?php if($lancamento->pagamentos()->count() > 0): ?>
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lancamento->pagamentos()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pagamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($pagamento->numero_parcela_pagamento); ?></td>
                                <td><?php echo e($pagamento->data_pagamento->format('d/m/Y')); ?></td>
                                <td>
                                    <?php
                                        $formaPagamento = DB::table('formas_pagamento')->where('id', $pagamento->forma_pagamento_id)->first();
                                    ?>
                                    <?php echo e($formaPagamento->nome ?? 'N/A'); ?>

                                </td>
                                <td>
                                    <?php if($pagamento->bandeira_id): ?>
                                        <?php
                                            $bandeira = DB::table('forma_pag_bandeiras')->where('id', $pagamento->bandeira_id)->first();
                                        ?>
                                        <?php echo e($bandeira->nome ?? 'N/A'); ?>
                                ...
                                <td>
                                    <?php if($pagamento->status_pagamento === 'confirmado'): ?>
                                        <span class="badge bg-success">Confirmado</span>
                                    <?php elseif($pagamento->status_pagamento === 'processando'): ?>
                                        <span class="badge bg-warning">Processando</span>
                                    <?php elseif($pagamento->status_pagamento === 'cancelado'): ?>
                                        <span class="badge bg-secondary">Cancelado</span>
                                    <?php elseif($pagamento->status_pagamento === 'estornado'): ?>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-sm btn-outline-info" 
                                                onclick="verDetalhesPagamento(<?php echo e($pagamento->id); ?>)"
                                                title="Ver Detalhes">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <?php if($pagamento->status_pagamento === 'confirmado'): ?>
                                        <button type="button" class="btn btn-sm btn-outline-danger" 
                                                onclick="estornarPagamento(<?php echo e($pagamento->id); ?>)"
                                                title="Estornar">
...
<script>
// Variáveis globais
const empresaId = <?php echo e($empresa->id); ?>;
const lancamentoId = <?php echo e($lancamento->id); ?>;
...
<?php echo $__env->make('layouts.comerciante', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciantes/financeiro/contas-pagar/show.blade.php ENDPATH**/ ?>