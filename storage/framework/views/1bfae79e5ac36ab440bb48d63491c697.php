...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('admin.payments.settings')); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <h3 class="text-primary"><?php echo e($gateways->count()); ?></h3>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/admin/payments/gateways.blade.php ENDPATH**/ ?>