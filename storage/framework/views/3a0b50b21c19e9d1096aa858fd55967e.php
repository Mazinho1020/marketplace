        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarFidelidade">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('admin.fidelidade.clientes')); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <strong>Cliente <?php echo e($cliente->cliente_id); ?></strong>
                                        <br><small class="text-muted">ID: <?php echo e($cliente->cliente_id); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="badge bg-light text-dark"><?php echo e($cliente->empresa_nome ?? 'Geral'); ?></span></td>
                            <td>
                            ...
                            <td>
                                <?php if($cliente->status == 'ativa'): ?>
                                    <span class="badge bg-success badge-status">Ativo</span>
                                <?php elseif($cliente->status == 'inativa'): ?>
                                    <span class="badge bg-warning badge-status">Inativo</span>
                                <?php else: ?>
                                    <span class="badge bg-secondary badge-status"><?php echo e(ucfirst($cliente->status ?? 'Ativo')); ?></span>
                                <?php endif; ?>
                            </td>
                            <td><small><?php echo e(\Carbon\Carbon::parse($cliente->criado_em)->format('d/m/Y')); ?></small></td>
                            <td>
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/admin/fidelidade/clientes.blade.php ENDPATH**/ ?>