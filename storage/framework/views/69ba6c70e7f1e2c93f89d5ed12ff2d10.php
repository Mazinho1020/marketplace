<?php $__env->startSection('title', 'Nova Pessoa'); ?>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">
                        Nova Pessoa
                        <?php if(request('tipo')): ?>
                            - <?php echo e(ucfirst(str_replace('_', ' ', request('tipo')))); ?>
                ...
                <div>
                    <a href="/comerciantes/clientes/pessoas<?php echo e(request('empresa_id') ? '?empresa_id=' . request('empresa_id') : ''); ?><?php echo e(request('tipo') ? (request('empresa_id') ? '&' : '?') . 'tipo=' . request('tipo') : ''); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="nome" name="nome" value="<?php echo e(old('nome')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="sobrenome" name="sobrenome" value="<?php echo e(old('sobrenome')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="nome_social" name="nome_social" value="<?php echo e(old('nome_social')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="cpf_cnpj" name="cpf_cnpj" value="<?php echo e(old('cpf_cnpj')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="data_nascimento" name="data_nascimento" value="<?php echo e(old('data_nascimento')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="genero" name="genero">
                                                ...
                                                <option value="outros" <?php echo e(old('genero') == 'outros' ? 'selected' : ''); ?>>Outros</option>
                                                <option value="nao_informar" <?php echo e(old('genero') == 'nao_informar' ? 'selected' : ''); ?>>Não informar</option>
                                            </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" 
                                                               ...
                                                               <?php echo e((is_array(old('tipos')) && in_array('cliente', old('tipos'))) || request('tipo') == 'cliente' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" 
                                                               ...
                                                               <?php echo e((is_array(old('tipos')) && in_array('funcionario', old('tipos'))) || request('tipo') == 'funcionario' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" 
                                                               ...
                                                               <?php echo e((is_array(old('tipos')) && in_array('fornecedor', old('tipos'))) || request('tipo') == 'fornecedor' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" 
                                                               ...
                                                               <?php echo e((is_array(old('tipos')) && in_array('entregador', old('tipos'))) || request('tipo') == 'entregador' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="campos_funcionario" class="col-12" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                                        ...
                                                        <?php $__currentLoopData = $configuracoes['departamentos'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($dept->id); ?>" <?php echo e(old('departamento_id') == $dept->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                                           id="data_admissao" name="data_admissao" value="<?php echo e(old('data_admissao')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                                           id="salario_atual" name="salario_atual" value="<?php echo e(old('salario_atual')); ?>" 
                                                           placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                                ...
                                                <option value="suspenso" <?php echo e(old('status') == 'suspenso' ? 'selected' : ''); ?>>Suspenso</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                                      ...
                                                      placeholder="Observações importantes..."><?php echo e(old('observacoes')); ?></textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <small class="text-muted">
                                ...
                                <ul>
                                    <li><strong>Cliente:</strong> Pessoa que compra produtos/serviços</li>
                                    <li><strong>Funcionário:</strong> Colaborador da empresa</li>
                                    <li><strong>Fornecedor:</strong> Empresa/pessoa que fornece produtos</li>
                                    <li><strong>Entregador:</strong> Responsável por entregas</li>
                                </ul>
                            </small>
                        </div>
                    </div>
...
<?php echo $__env->make('comerciantes.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciante/pessoas/create.blade.php ENDPATH**/ ?>