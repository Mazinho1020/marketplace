                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            ...
                            <?php if($contaReceber->data_vencimento->isPast() && $contaReceber->situacao_financeira->value == 'pendente'): ?>
                        ...
                        <dd class="col-sm-9">
                            <?php echo e($contaReceber->numero_documento ?: 'NÃ£o informado'); ?>

                        </dd>

                        <dt class="col-sm-3">ObservaÃ§Ãµes:</dt>
                        <dd class="col-sm-9">
                            <?php echo e($contaReceber->observacoes ?: 'NÃ£o informado'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-6">R$ <?php echo e(number_format($contaReceber->valor_original, 2, ',', '.')); ?></dd>
                        ...
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-6"><strong class="fs-5 text-primary">R$ <?php echo e(number_format($contaReceber->valor_final, 2, ',', '.')); ?></strong></dd>

                                <?php if($contaReceber->situacao_financeira->value == 'pago' && $contaReceber->data_pagamento): ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                <div class="text-center">
                                    ...
                                    <h5 class="text-primary mb-0">R$ <?php echo e(number_format($resumoRecebimentos['valor_total'], 2, ',', '.')); ?></h5>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center">
                                    <h6 class="text-muted mb-1">Total Recebido</h6>
                                    <h5 class="text-success mb-0">R$ <?php echo e(number_format($resumoRecebimentos['valor_recebido'], 2, ',', '.')); ?></h5>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center">
                                ...
                                <dd class="col-6">
                                    <?php if($contaReceber->data_vencimento->isPast() && $contaReceber->situacao_financeira->value == 'pendente'): ?>
                                        <span class="text-danger fw-bold">
                                            ...
                                            <small>(Vencida hÃ¡ <?php echo e($contaReceber->data_vencimento->diffForHumans()); ?>)</small>
                                        </span>
                                    <?php else: ?>
                                        <?php echo e($contaReceber->data_vencimento->format('d/m/Y')); ?>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <h3 class="text-primary mb-1">
                            R$ <?php echo e(number_format($contaReceber->valor_final, 2, ',', '.')); ?>
                        ...
                        <?php if($contaReceber->situacao_financeira->value == 'pendente'): ?>
                            ...
                            <?php else: ?>
                                <p class="text-danger mb-0">
                                    ...
                                    Vencida hÃ¡ <?php echo e($contaReceber->data_vencimento->diffForHumans()); ?>
            ...
            <?php if($contaReceber->data_vencimento->isPast() && $contaReceber->situacao_financeira->value == 'pendente'): ?>
                <div class="card border-danger mb-4">
                    ...
                    <div class="card-body">
                        <p class="mb-2">Esta conta estÃ¡ vencida hÃ¡ <?php echo e($contaReceber->data_vencimento->diffForHumans()); ?>.</p>
            ...
            <?php if($contaReceber->data_vencimento->isToday() && $contaReceber->situacao_financeira->value == 'pendente'): ?>
