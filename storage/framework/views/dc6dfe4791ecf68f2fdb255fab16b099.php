...
<body>
            ...
            <div class="navbar-nav ms-auto">
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center text-white" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                        ...
                        <span class="fw-medium"><?php echo e($user->nome ?? 'Admin'); ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" style="border-radius: 10px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                        <li><h6 class="dropdown-header">Nível: <?php echo e($user->tipo_nome ?? 'Administrador'); ?></h6></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="#"><i class="mdi mdi-account-circle me-2"></i>Perfil</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.config.index')); ?>"><i class="mdi mdi-cog me-2"></i>Configurações</a></li>
                        <li><hr class="dropdown-divider"></li>
    ...
    <div class="container-fluid">
        <div class="main-content">
                    ...
                    <div class="card user-info">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h3 class="mb-2">Bem-vindo, <?php echo e($user->nome ?? 'Administrador'); ?>!</h3>
                                    <p class="mb-0 opacity-75">
                                        <i class="mdi mdi-shield-account me-2"></i><?php echo e($user->tipo_nome ?? 'Administrador'); ?> - <?php echo e($user->empresa ?? 'Sistema'); ?>

                                    </p>
                                    <small class="opacity-75">
                                        <i class="mdi mdi-clock-outline me-1"></i>Último acesso: <?php echo e(now()->format('d/m/Y H:i')); ?>
                                ...
                                <div class="col-md-4 text-end">
                                    <div class="d-flex justify-content-end">
                                        <div class="text-center me-4">
                                            <div class="h4 mb-0"><?php echo e(date('d')); ?></div>
                                            <small><?php echo e(date('M/Y')); ?></small>
                                        </div>
                                        <div class="text-center">
                                            <div class="h4 mb-0"><?php echo e(date('H:i')); ?></div>
                                            <small><?php echo e(date('D')); ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card stat-card">
                        <div class="card-body">
                            ...
                            <h4 class="stat-number"><?php echo e($systemStats['total_usuarios'] ?? 0); ?></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card stat-card stat-card-success">
                        <div class="card-body">
                            ...
                            <h4 class="stat-number"><?php echo e($systemStats['total_empresas'] ?? 0); ?></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card stat-card stat-card-info">
                        <div class="card-body">
                            ...
                            <h4 class="stat-number"><?php echo e($systemStats['total_pedidos'] ?? 0); ?></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card stat-card stat-card-warning">
                        <div class="card-body">
                            ...
                            <h4 class="stat-number"><?php echo e($systemStats['total_produtos'] ?? 0); ?></h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="badge bg-<?php echo e($databaseInfo['status_class'] ?? 'secondary'); ?> ms-2">
                                            <i class="mdi mdi-circle me-1"></i><?php echo e($databaseInfo['status'] ?? 'N/A'); ?>

                                        </span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Driver:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['driver'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Host:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['host'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Porta:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['port'] ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Nome do Banco:</label>
                                        <span class="ms-2 text-primary fw-medium"><?php echo e($databaseInfo['database'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Charset:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['charset'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Versão:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['version'] ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Conexão:</label>
                                        <span class="ms-2"><?php echo e($databaseInfo['connection_name'] ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="mb-4">
                                <div class="stat-number text-primary" style="font-size: 2.5rem;"><?php echo e($databaseInfo['total_tables'] ?? 0); ?></div>
                                <p class="stat-label text-muted">Total de Tabelas</p>
                            </div>
                            <div class="mb-3">
                                <div class="h4 text-success"><?php echo e($databaseInfo['size'] ?? 'N/A'); ?></div>
                                <p class="text-muted mb-0">Tamanho do Banco</p>
                            </div>
                            <?php if(isset($databaseInfo['error'])): ?>
                            <div class="alert alert-warning alert-sm mt-3">
                                <small><i class="mdi mdi-alert me-1"></i><?php echo e($databaseInfo['error']); ?></small>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1"><?php echo e($fidelidadeStats['total_programas'] ?? 0); ?></h5>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1"><?php echo e($fidelidadeStats['total_clientes'] ?? 0); ?></h5>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1"><?php echo e($fidelidadeStats['total_cartoes'] ?? 0); ?></h5>
                                <small>Cartões</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1"><?php echo e($fidelidadeStats['total_transacoes'] ?? 0); ?></h5>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1"><?php echo e(number_format($fidelidadeStats['total_pontos'] ?? 0, 0, ',', '.')); ?></h5>
                                <small>Pontos</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-4 col-md-6 mb-3">
                        <div class="card fidelidade-card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="mb-1">R$ <?php echo e(number_format($fidelidadeStats['total_cashback'] ?? 0, 2, ',', '.')); ?></h5>
            ...
            <?php if(isset($systemAlerts) && count($systemAlerts) > 0): ?>
            <div class="row mb-4">
                <div class="col-12">
                    <h4 class="section-title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="alert alert-item alert-<?php echo e($alert['type'] ?? 'info'); ?> mb-0">
                                <h6 class="alert-heading">
                                    <i class="mdi mdi-<?php echo e($alert['icon'] ?? 'information'); ?> me-2"></i>
                                    <?php echo e($alert['title'] ?? 'Alerta'); ?>

                                </h6>
                                <p class="mb-0"><?php echo e($alert['message'] ?? 'Mensagem do alerta'); ?></p>
                                <?php if(isset($alert['count'])): ?>
                                <small class="text-muted">Total: <?php echo e($alert['count']); ?></small>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        const trendsChart = new Chart(ctx1, {
            type: 'line',
            data: {
                labels: <?php echo json_encode(array_column($chartData['usuarios_por_mes'] ?? [], 'mes'), 512) ?>,
                datasets: [{
                    label: 'Usuários',
                    data: <?php echo json_encode(array_column($chartData['usuarios_por_mes'] ?? [], 'count'), 512) ?>,
                    borderColor: '#667eea',
                    backgroundColor: 'rgba(102, 126, 234, 0.1)',
                    tension: 0.4
                }, {
                    label: 'Vendas (R$)',
                    data: <?php echo json_encode(array_column($chartData['vendas_por_mes'] ?? [], 'valor'), 512) ?>,
                    borderColor: '#38ef7d',
        ...
        const topProductsChart = new Chart(ctx2, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode(array_column($chartData['top_produtos'] ?? [], 'nome'), 512) ?>,
                datasets: [{
                    data: <?php echo json_encode(array_column($chartData['top_produtos'] ?? [], 'vendas'), 512) ?>,
                    backgroundColor: [
                        '#667eea',
                        '#38ef7d',
                        '#f093fb',
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/admin/dashboard-professional.blade.php ENDPATH**/ ?>