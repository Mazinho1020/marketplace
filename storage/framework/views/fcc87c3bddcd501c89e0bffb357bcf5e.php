        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('Theme1/images/logo-sm.png')); ?>" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('Theme1/images/logo-dark.png')); ?>" alt="" height="24">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('Theme1/images/logo-light.png')); ?>" alt="" height="24">
                        <span class="logo-txt">Marketplace</span>
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <img class="rounded-circle header-profile-user" src="<?php echo e(Auth::user()->avatar ?? asset('Theme1/images/users/avatar-1.jpg')); ?>" alt="Header Avatar">
                        <span class="text-start ms-xl-2">
                            <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text"><?php echo e(Auth::user()->name ?? 'Usuário'); ?></span>
                            <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(Auth::user()->tipo_nome ?? 'Administrador'); ?></span>
                        </span>
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <h6 class="dropdown-header">Bem-vindo <?php echo e(Auth::user()->name ?? 'Usuário'); ?>!</h6>
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/layouts/header.blade.php ENDPATH**/ ?>