<?php $__env->startSection('title', 'Sistema Financeiro'); ?>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('comerciantes.empresas.financeiro.dashboard', $empresa)); ?>" class="btn btn-outline-primary me-2">
        ...
        <div class="col-md-3">
            <div class="card dashboard-card">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.index', $empresa)); ?>" class="btn btn-primary">
        ...
        <div class="col-md-3">
            <div class="card dashboard-card">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-receber.index', $empresa)); ?>" class="btn btn-success">
                        <i class="fas fa-arrow-right"></i> Acessar
                    </a>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-pagar.create', $empresa)); ?>" class="quick-action-btn">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas-receber.create', $empresa)); ?>" class="quick-action-btn">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas.create', $empresa)); ?>" class="quick-action-btn">
            ...
            <div class="card dashboard-card">
                <div class="card-header bg-transparent border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas.create', $empresa)); ?>" 
                ...
                <div class="card-body">
                    <?php if($contas->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-modern table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <code class="bg-light px-2 py-1 rounded"><?php echo e($conta->codigo ?: 'N/A'); ?></code>
                                        </td>
                                        <td>
                                            <div>
                                                <div class="fw-bold"><?php echo e($conta->nome); ?></div>
                                                <?php if($conta->descricao): ?>
                                                    <small class="text-muted"><?php echo e(Str::limit($conta->descricao, 50)); ?></small>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if($conta->categoria): ?>
                                                <span class="badge bg-primary rounded-pill">
                                                    <?php echo e($conta->categoria->nome); ?>
                                        ...
                                        <td>
                                            <?php if($conta->natureza): ?>
                                                <span class="badge bg-<?php echo e($conta->natureza->color()); ?> rounded-pill">
                                                    <i class="fas fa-<?php echo e($conta->natureza->icon()); ?>"></i>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas.show', [$empresa, $conta->id])); ?>" 
                                                   class="btn btn-sm btn-outline-info" title="Visualizar">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas.edit', [$empresa, $conta->id])); ?>" 
                        ...
                        <!-- Paginação -->
                        <?php if($contas instanceof \Illuminate\Pagination\LengthAwarePaginator && $contas->hasPages()): ?>
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <div class="pagination-info">
                                    <span class="text-muted">
                                        <i class="fas fa-info-circle"></i>
                                        Mostrando <?php echo e($contas->firstItem()); ?> até <?php echo e($contas->lastItem()); ?> 
                                        de <?php echo e($contas->total()); ?> contas
                                    </span>
                                </div>
...
<?php echo $__env->make('layouts.comerciante', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciantes/financeiro/contas/index.blade.php ENDPATH**/ ?>