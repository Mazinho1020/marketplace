...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-footer">
            ...
            <div class="mt-3">
                <p>&copy; MeuFinanceiro <?php echo e(date('Y')); ?></p>
                <p class="mb-0">Versão 2.0 | <?php echo e(request()->getHost()); ?></p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\marketplace\resources\views/auth/login-simplified.blade.php ENDPATH**/ ?>