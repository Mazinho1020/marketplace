<?php $__env->startSection('title', 'Fidelidade - Admin'); ?>
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('admin.fidelidade.deletados')); ?>" class="btn btn-warning">
            ...
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="mb-0"><?php echo e(number_format($estatisticas['carteiras_total'])); ?></h3>
                    ...
                    <small><?php echo e($estatisticas['carteiras_ativas']); ?> ativas | <?php echo e($estatisticas['carteiras_deletadas']); ?> deletadas</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="mb-0"><?php echo e(number_format($estatisticas['cupons_total'])); ?></h3>
                    ...
                    <small><?php echo e($estatisticas['cupons_ativos']); ?> ativos | <?php echo e($estatisticas['cupons_deletados']); ?> deletados</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="mb-0"><?php echo e(number_format($estatisticas['creditos_total'])); ?></h3>
                    ...
                    <small><?php echo e($estatisticas['creditos_ativos']); ?> ativos | <?php echo e($estatisticas['creditos_deletados']); ?> deletados</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="mb-0"><?php echo e(number_format($estatisticas['transacoes_total'])); ?></h3>
                    ...
                    <small><?php echo e($estatisticas['transacoes_deletadas']); ?> deletadas</small>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'carteiras')); ?>" class="btn btn-warning btn-sm">Deletadas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'cupons')); ?>" class="btn btn-warning btn-sm">Deletados</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'creditos')); ?>" class="btn btn-warning btn-sm">Deletados</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'conquistas')); ?>" class="btn btn-warning btn-sm">Deletadas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'transacoes')); ?>" class="btn btn-warning btn-sm">Deletadas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border">
                                <div class="card-body text-center">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('admin.fidelidade.deletados', 'regras')); ?>" class="btn btn-warning btn-sm">Deletadas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/admin/fidelidade/index.blade.php ENDPATH**/ ?>