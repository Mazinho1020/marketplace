                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <a href="<?php echo e(route('comerciantes.empresas.financeiro.dashboard', $empresa)); ?>" 
                                ...
                                <a href="<?php echo e(route('comerciantes.empresas.financeiro.categorias.index', $empresa)); ?>" 
                                   class="btn btn-outline-success btn-sm">
...
<?php echo $__env->make('layouts.comerciante', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciantes/empresas/show.blade.php ENDPATH**/ ?>