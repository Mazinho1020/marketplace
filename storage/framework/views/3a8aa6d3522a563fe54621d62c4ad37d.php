                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        <a href="<?php echo e(route('comerciantes.empresas.financeiro.contas.index', $empresa)); ?>" class="btn btn-success btn-sm">
                                            Gerenciar Contas
                                        </a>
                                    </p>
                                </div>
...
<?php echo $__env->make('comerciantes.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketplace\resources\views/comerciantes/financeiro/dashboard.blade.php ENDPATH**/ ?>