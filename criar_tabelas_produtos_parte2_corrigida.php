<?php
// Criar tabelas avançadas corrigidas do sistema de produtos
try {
    $pdo = new PDO('mysql:host=127.0.0.1;dbname=meufinanceiro', 'root', 'root');
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    echo "=== CRIANDO TABELAS AVANÇADAS CORRIGIDAS DO SISTEMA DE PRODUTOS ===\n\n";

    // 9. MOVIMENTAÇÕES DE ESTOQUE (corrigida)
    ...
    // 11. FORNECEDORES POR PRODUTO (corrigida)
    ...
    $pdo->exec("
        ...
        CREATE TABLE produto_fornecedores (
            ...
            empresa_id int NOT NULL DEFAULT 0,
            produto_id int unsigned NOT NULL,
            fornecedor_pessoa_id bigint unsigned NOT NULL,
    ...
    // 13. KITS E COMBOS
    echo "13. Criando tabela produto_kits...\n";
    $pdo->exec("
        DROP TABLE IF EXISTS produto_kits;
    ...
    // 14. CÓDIGOS DE BARRAS ALTERNATIVOS
    echo "14. Criando tabela produto_codigos_barras...\n";
    $pdo->exec("
        ...
        CREATE TABLE produto_codigos_barras (
            ...
            tipo enum('ean13','ean8','upca','upce','code128','code39','qrcode','datamatrix') DEFAULT 'ean13',
            principal tinyint(1) DEFAULT 0,
            ativo tinyint(1) DEFAULT 1,
            created_at timestamp DEFAULT CURRENT_TIMESTAMP,
            updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    echo "15. Criando tabela produto_relacionados...\n";
    $pdo->exec("
        DROP TABLE IF EXISTS produto_relacionados;
        CREATE TABLE produto_relacionados (
            id int unsigned NOT NULL AUTO_INCREMENT,
            empresa_id int NOT NULL DEFAULT 0,
            produto_id int unsigned NOT NULL,
            produto_relacionado_id int unsigned NOT NULL,
            tipo_relacao enum('similar','complementar','acessorio','substituto','kit','cross-sell','up-sell') DEFAULT 'similar',
            ordem int DEFAULT 0,
            ativo tinyint(1) DEFAULT 1,
            created_at timestamp DEFAULT CURRENT_TIMESTAMP,
            updated_at timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
