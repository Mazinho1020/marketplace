...
@section('title', 'Nova Entrada de Histórico')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">Nova Entrada de Histórico</h1>
                    <p class="text-muted">Registre uma nova alteração de preço</p>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-history me-2"></i>Dados da Alteração
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('comerciantes.produtos.historico-precos.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" 
                                           ...
                                           value="{{ old('data_alteracao', now()->format('Y-m-d\TH:i')) }}" 
                                           required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('preco_venda_anterior') }}" 
                                               step="0.01" 
                                               min="0"
                                               required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('preco_compra_anterior') }}" 
                                               step="0.01" 
                                               min="0">
                                    </div>
                        ...
                        <!-- Painel de Cálculos -->
                        <div class="card bg-light mb-3" id="calculo-painel" style="display: none;">
                            <div class="card-body">
                                <h6 class="card-title">Análise da Alteração</h6>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <div class="h5 mb-0" id="variacao-valor">R$ 0,00</div>
                                            <small class="text-muted">Variação Monetária</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <div class="h5 mb-0" id="variacao-percentual">0%</div>
                                            <small class="text-muted">Variação Percentual</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <div class="h5 mb-0" id="tipo-alteracao">-</div>
                        ...
                        <div class="border-top pt-3">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Salvar Histórico
                                </button>
                            </div>
                        </div>
                    </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const precoCompraAnteriorInput = document.getElementById('preco_compra_anterior');
    const precoCompraNovoInput = document.getElementById('preco_compra_novo');
    const calculoPainel = document.getElementById('calculo-painel');
    
    // Auto-preencher preço anterior quando selecionar produto
    produtoSelect.addEventListener('change', function() {
        const selectedOption = this.options[this.selectedIndex];
        if (selectedOption.value) {
            const precoAtual = selectedOption.dataset.precoAtual;
            const precoCompra = selectedOption.dataset.precoCompra;
            
            precoAnteriorInput.value = precoAtual;
            precoCompraAnteriorInput.value = precoCompra || '';
        }
    });
    ...
    function calcularVariacoes() {
        ...
        if (precoAnterior > 0 && precoNovo > 0) {
            ...
            calculoPainel.style.display = 'block';
        } else {
            calculoPainel.style.display = 'none';
        }
    }
