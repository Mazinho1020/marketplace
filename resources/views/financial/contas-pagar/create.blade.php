...
@section('financial-title', 'Nova Conta a Pagar')
...
<div class="container-fluid p-4">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Cadastre uma nova conta a pagar no sistema</p>
                </div>
                <div>
    ...
    <form method="POST" action="{{ route('financial.contas-pagar.store') }}" id="formContaPagar">
        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="pessoa_id" class="form-select @error('pessoa_id') is-invalid @enderror">
                                    ...
                                    @foreach($fornecedores as $fornecedor)
                                        <option value="{{ $fornecedor->id }}" {{ old('pessoa_id') == $fornecedor->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="categoria" class="form-select @error('categoria') is-invalid @enderror">
                                    ...
                                    <option value="fornecedores" {{ old('categoria') == 'fornecedores' ? 'selected' : '' }}>Fornecedores</option>
                                    <option value="aluguel" {{ old('categoria') == 'aluguel' ? 'selected' : '' }}>Aluguel</option>
                                    <option value="energia" {{ old('categoria') == 'energia' ? 'selected' : '' }}>Energia Elétrica</option>
                                    <option value="agua" {{ old('categoria') == 'agua' ? 'selected' : '' }}>Água</option>
                                    <option value="telefone" {{ old('categoria') == 'telefone' ? 'selected' : '' }}>Telefone/Internet</option>
                                    <option value="combustivel" {{ old('categoria') == 'combustivel' ? 'selected' : '' }}>Combustível</option>
                                    <option value="manutencao" {{ old('categoria') == 'manutencao' ? 'selected' : '' }}>Manutenção</option>
                                    <option value="marketing" {{ old('categoria') == 'marketing' ? 'selected' : '' }}>Marketing</option>
                                    <option value="impostos" {{ old('categoria') == 'impostos' ? 'selected' : '' }}>Impostos</option>
                    ...
                    <div class="card-body" id="parcelamentoContent" style="display: none;">
                        ...
                        <div class="mt-3">
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>
                                <strong>Importante:</strong> O parcelamento criará múltiplas contas a pagar com as datas de vencimento calculadas automaticamente.
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="observacoes" class="form-control @error('observacoes') is-invalid @enderror" 
                                          rows="4" placeholder="Informações adicionais sobre esta conta a pagar...">{{ old('observacoes') }}</textarea>
                                @error('observacoes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card financial-card mb-4 sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        <div class="row g-3 text-center">
                            <div class="col-12">
                                <h3 class="text-danger mb-0" id="valorTotal">R$ 0,00</h3>
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                                ...
                                <small>Use descrições claras e específicas</small>
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                <small>Categorize suas contas para melhor controle</small>
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                <small>O parcelamento facilita o controle de contas recorrentes</small>
                            </li>
                            <li class="mb-0">
                                <i class="fas fa-check text-success me-2"></i>
                                <small>Adicione observações para informações importantes</small>
                            </li>
                        </ul>
                    </div>
                </div>
