    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="{{ route('admin.fidelidade.relatorios') }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="periodo-badge">
                            <i class="mdi mdi-calendar"></i> {{ $relatorio['periodo']['inicio'] }} - {{ $relatorio['periodo']['fim'] }}
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-primary">{{ number_format($relatorio['transacoes_periodo'], 0, ',', '.') }}</h3>
                        </div>
                ...
                <div class="stats-card">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-success">R$ {{ number_format($relatorio['valor_periodo'], 2, ',', '.') }}</h3>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="stats-card">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-info">R$ {{ number_format($relatorio['cashback_periodo'], 2, ',', '.') }}</h3>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="stats-card">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0 text-warning">{{ number_format($relatorio['novos_clientes'], 0, ',', '.') }}</h3>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="relatorio-card">
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            {{ $relatorio['novos_clientes'] > 0 ? number_format(($relatorio['transacoes_periodo'] / $relatorio['novos_clientes']) * 100, 1) : 0 }}%
                        </div>
                    </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            R$ {{ $relatorio['transacoes_periodo'] > 0 ? number_format($relatorio['valor_periodo'] / $relatorio['transacoes_periodo'], 2, ',', '.') : '0,00' }}
                        </div>
                    </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            R$ {{ $relatorio['transacoes_periodo'] > 0 ? number_format($relatorio['cashback_periodo'] / $relatorio['transacoes_periodo'], 2, ',', '.') : '0,00' }}
                        </div>
                    </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            {{ $relatorio['valor_periodo'] > 0 ? number_format(($relatorio['cashback_periodo'] / $relatorio['valor_periodo']) * 100, 2) : 0 }}%
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="relatorio-card">
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            {{ number_format($relatorio['cupons_utilizados'], 0, ',', '.') }}
                        </div>
                    </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            {{ $relatorio['transacoes_periodo'] > 0 ? number_format(($relatorio['cupons_utilizados'] / $relatorio['transacoes_periodo']) * 100, 1) : 0 }}%
                        </div>
                    </div>
                    ...
                    <div class="metric-item">
                        ...
                        <div class="metric-value">
                            {{ $relatorio['novos_clientes'] > 0 ? number_format($relatorio['cupons_utilizados'] / $relatorio['novos_clientes'], 1) : 0 }}
                        </div>
                    </div>
