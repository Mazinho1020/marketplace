...
<head>
    ...
    <link rel="st                        <div>
                        ...
                        </div>heet" href="/Theme1/css/bootstrap.min.css">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stats-card info">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1">Valor Total</h6>
                            <h4 class="mb-0">R$ {{ number_format($stats['valor_total'], 2, ',', '.') }}</h4>
                        </div>
                        <div class="align-self-center">
            ...
            <div class="col-md-3">
                <div class="stats-card warning">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1">Valor Pedidos</h6>
                            <h4 class="mb-0">R$ {{ number_format($stats['valor_pedidos'], 2, ',', '.') }}</h4>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="stats-card danger">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h4 class="mb-0">R$ {{ number_format($stats['total_cashback'], 2, ',', '.') }}</h4>
                        </div>
                        <div class="align-self-center">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><code>TXN{{ str_pad($transacao->id, 3, '0', STR_PAD_LEFT) }}</code></td>
                            <td><small>{{ \Carbon\Carbon::parse($transacao->created_at)->format('d/m/Y H:i') }}</small></td>
                            <td><strong>Cliente {{ $transacao->cliente_id }}</strong></td>
                            <td><span class="badge bg-light text-dark">{{ $transacao->empresa_nome ?? 'Geral' }}</span></td>
                            <td>
                                <span class="transaction-type {{ $transacao->tipo == 'credito' ? 'credito' : 'debito' }}">
                                    @if($transacao->tipo == 'credito')
                                        <i class="mdi mdi-plus me-1"></i> Crédito
                                    @else
                                        <i class="mdi mdi-minus me-1"></i> Débito
                                    @endif
                                </span>
                            </td>
                            <td><strong>R$ {{ number_format($transacao->valor_pedido_original ?? $transacao->valor, 2, ',', '.') }}</strong></td>
                            <td>
                                <span class="{{ $transacao->valor >= 0 ? 'valor-positivo' : 'valor-negativo' }}">
                                    {{ $transacao->valor >= 0 ? '+' : '' }}{{ number_format($transacao->valor, 2, ',', '.') }} pts
                                </span>
                            </td>
                            <td><strong class="valor-positivo">R$ {{ number_format($transacao->valor, 2, ',', '.') }}</strong></td>
                            <td>
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                ...
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalNovaTransacao">
                                    <i class="mdi mdi-plus"></i> Criar Primeira Transação
                                </button>
                            </td>
                        </tr>
                        @endforelse
