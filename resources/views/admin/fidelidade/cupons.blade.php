                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                ...
                                <br><strong class="text-success">
                                    {{ $cupom->valor ?? '0' }}{{ ($cupom->tipo_desconto ?? 'percentual') == 'percentual' ? '%' : '' }}
                                </strong>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                ...
                                <br><small>{{ isset($cupom->data_fim) ? \Carbon\Carbon::parse($cupom->data_fim)->format('d/m/Y') : 'N/A' }}</small>
                            </div>
                        </div>
                    </div>
