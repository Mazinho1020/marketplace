        ...
        <div class="col-xl-3 col-md-6">
            <div class="card tilebox-one">
                <div class="card-body">
                    ...
                    <h2 class="m-b-20" id="stats-hoje">{{ $stats['hoje'] ?? 0 }}</h2>
                    <span class="badge bg-success"> +{{ $stats['crescimento_hoje'] ?? '0%' }} </span>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card tilebox-one">
                <div class="card-body">
                    ...
                    <h2 class="m-b-20" id="stats-pendentes">{{ $stats['pendentes'] ?? 0 }}</h2>
                    <span class="badge bg-warning"> {{ $stats['agendadas'] ?? 0 }} agendadas </span>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card tilebox-one">
                <div class="card-body">
                    ...
                    <h2 class="m-b-20" id="stats-sucesso">{{ $stats['taxa_sucesso'] ?? '98.5%' }}</h2>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card tilebox-one">
                <div class="card-body">
                    ...
                    <h2 class="m-b-20" id="stats-templates">{{ $stats['templates_ativos'] ?? 0 }}</h2>
                    <span class="badge bg-info"> {{ $stats['total_templates'] ?? 0 }} total </span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="border rounded p-3 mb-3">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('admin.notificacoes.templates') }}" class="btn btn-outline-primary btn-sm">
                                        <i class="mdi mdi-file-document-edit"></i> Templates
                                    </a>
                                    <a href="{{ route('admin.notificacoes.tipos') }}" class="btn btn-outline-primary btn-sm">
                                        <i class="mdi mdi-format-list-bulleted"></i> Tipos de Evento
                                    </a>
                                    <a href="{{ route('admin.notificacoes.aplicacoes') }}" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="border rounded p-3 mb-3">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('admin.notificacoes.enviadas') }}" class="btn btn-outline-success btn-sm">
                                        <i class="mdi mdi-send"></i> Enviadas
                                    </a>
                                    <a href="{{ route('admin.notificacoes.estatisticas') }}" class="btn btn-outline-success btn-sm">
                                        <i class="mdi mdi-chart-line"></i> Estatísticas
                                    </a>
                                    <a href="{{ route('admin.notificacoes.logs') }}" class="btn btn-outline-success btn-sm">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="border rounded p-3 mb-3">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('admin.notificacoes.teste') }}" class="btn btn-outline-warning btn-sm">
                                        <i class="mdi mdi-test-tube"></i> Página de Teste
                                    </a>
                                    <a href="{{ route('admin.notificacoes.diagnostico') }}" class="btn btn-outline-warning btn-sm">
                                        <i class="mdi mdi-stethoscope"></i> Diagnóstico
                                    </a>
                                    <a href="{{ route('admin.notificacoes.configuracoes') }}" class="btn btn-outline-warning btn-sm">
