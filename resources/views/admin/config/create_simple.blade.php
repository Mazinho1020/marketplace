...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.config.store') }}" method="POST" id="configForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" 
                                   value="{{ old('nome') }}" placeholder="Nome descritivo da configuração" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="chave" name="chave" 
                                   value="{{ old('chave') }}" placeholder="chave_unica_configuracao" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="valor_padrao" name="valor_padrao" 
                                   value="{{ old('valor_padrao') }}" placeholder="Valor padrão da configuração">
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="descricao" name="descricao" rows="3" 
                                      placeholder="Descrição detalhada da configuração">{{ old('descricao') }}</textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="valor_inicial" name="valor_inicial" 
                                   value="{{ old('valor_inicial') }}" placeholder="Valor inicial para esta configuração">
