            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @foreach($availableGateways as $code => $gateway)
                        <div class="col-md-6 mb-3">
                            <div class="card border">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <i class="uil {{ $gateway['icon'] }} text-{{ $gateway['color'] }} me-2" style="font-size: 1.5rem;"></i>
                                            <h6 class="mb-0">{{ $gateway['name'] }}</h6>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="{{ $code }}Enabled" checked>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm mt-2 w-100" onclick="configureGateway('{{ $code }}')">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border">
                                <div class="card-body text-center">
                                    <i class="uil {{ $method['icon'] }} text-{{ $method['color'] }} mb-2" style="font-size: 2rem;"></i>
                                    <h6 class="mb-2">{{ $method['name'] }}</h6>
                                    <div class="form-check form-switch d-flex justify-content-center">
                                        <input class="form-check-input" type="checkbox" id="{{ $code }}Method" checked>
                                    </div>
                ...
                <div class="card-body">
                    <form id="webhookSettingsForm">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" name="webhook_base_url" value="{{ url('/') }}/webhooks/payments">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="text-muted">{{ now()->subHours(2)->format('d/m/Y H:i') }}</div>
                    </div>
