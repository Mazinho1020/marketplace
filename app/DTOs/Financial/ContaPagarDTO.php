...
class ContaPagarDTO
{
    public function __construct(
        ...
        public readonly ?bool $pagamento_automatico = false,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            pagamento_automatico: (bool) ($data['pagamento_automatico'] ?? false),
    ...
    public function toArray(): array
    {
        return [
            ...
            'pagamento_automatico' => $this->pagamento_automatico,
